...
/**
 * Embedded CCP site infrastructure, which deploys site content to an S3 bucket.
 */
export class EmbeddedCCPStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    super(scope, id, props);

    // Create new Origin Access Identity
    const originAccessIdentity = new cloudfront.OriginAccessIdentity(this, 'OriginAccessIdentity', {
      comment: `OAI for Amazon Connect Audio Optimization for Citrix - Embedded CCP`
    }); 

    // S3 bucket for storing the website's files
    const siteBucket = new s3.Bucket(this, 'EmbeddedCCPStackBucket', {
    ...
    new cdk.CfnOutput(this, 'Embedded CCP URL', {
    ...
    NagSuppressions.addResourceSuppressionsByPath(this,
      '/EmbeddedCCPStack/Custom::CDKBucketDeployment8693BB64968944B69AAFB0CC9EB8756C/ServiceRole/Resource',        
      [
        {
      ...
      NagSuppressions.addResourceSuppressionsByPath(this,
        '/EmbeddedCCPStack/Custom::CDKBucketDeployment8693BB64968944B69AAFB0CC9EB8756C/Resource',
      [
        {
          id: 'AwsSolutions-L1',
