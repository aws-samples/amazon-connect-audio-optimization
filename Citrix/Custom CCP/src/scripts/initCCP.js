...
export default function (ccpContainerId, softphoneManagerParams) {
    ...
    try {    
        if (softphoneManagerParams) {
            console.debug("CDEBUG >> SoftphoneManager initialization() - softphoneManagerParams:", softphoneManagerParams);            
    ...
    // Subscribe to interface events when agent clicks on a different contact tab    
